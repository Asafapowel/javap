...
//    Long queryForCount(String where);

//    Page queryForPage(String where, Integer pageNo);
    ...
    /**
     * 
     * @return List of the objects from selected institution
     */
    List<T> getByInstitution(String institutionCode);
     ...
     * @return
     */
    T get(PK id, String institutionCode);
